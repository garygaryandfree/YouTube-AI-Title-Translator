...
AI Title Translator ist eine Chrome-Erweiterung, die YouTube-Videotitel mit KI übersetzt. Der übersetzte Titel wird an der Titelposition angezeigt, während der Originaltitel darunter zum Vergleichen, Lesen und Lernen erhalten bleibt.

Seit v8.0.1 ist die Erweiterung nicht mehr nur ein Werkzeug zum Übersetzen ins Chinesische. Sie verarbeitet gängige YouTube-Titelsprachen automatisch und übersetzt in Englisch, Japanisch, Koreanisch, Thai, Spanisch, Französisch, Deutsch, Portugiesisch, Indonesisch, Vietnamesisch und Chinesisch.
