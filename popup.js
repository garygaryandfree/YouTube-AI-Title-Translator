...
Object.assign(UI_TEXT.ja, {
    ...
    supportDeveloper: "開発者を支援", privacyNote: "v8.0 | このブラウザ内にのみ保存され、開発者へデータは送信されません。",
...
Object.assign(UI_TEXT.ko, {
    ...
    supportDeveloper: "개발자 지원", privacyNote: "v8.0 | 이 브라우저에만 저장되며 개발자에게 데이터가 업로드되지 않습니다.",
...
Object.assign(UI_TEXT.th, {
    ...
    supportDeveloper: "สนับสนุนนักพัฒนา", privacyNote: "v8.0 | บันทึกเฉพาะในเบราว์เซอร์นี้ ไม่มีการอัปโหลดข้อมูลให้ผู้พัฒนา",
...
Object.assign(UI_TEXT.es, {
    ...
    supportDeveloper: "Apoyar al desarrollador", privacyNote: "v8.0 | Se guarda solo en este navegador. No se suben datos al desarrollador.",
...
Object.assign(UI_TEXT.fr, {
    ...
    supportDeveloper: "Soutenir le développeur", privacyNote: "v8.0 | Stocké uniquement dans ce navigateur. Aucune donnée n'est envoyée au développeur.",
...
Object.assign(UI_TEXT.de, {
    ...
    supportDeveloper: "Entwickler unterstützen", privacyNote: "v8.0 | Nur in diesem Browser gespeichert. Keine Daten werden an den Entwickler hochgeladen.",
...
Object.assign(UI_TEXT.pt, {
    ...
    supportDeveloper: "Apoiar desenvolvedor", privacyNote: "v8.0 | Salvo apenas neste navegador. Nenhum dado é enviado ao desenvolvedor.",
...
Object.assign(UI_TEXT.id, {
    ...
    supportDeveloper: "Dukung pengembang", privacyNote: "v8.0 | Hanya disimpan di browser ini. Tidak ada data yang diunggah ke pengembang.",
...
Object.assign(UI_TEXT.vi, {
    ...
    supportDeveloper: "Ủng hộ nhà phát triển", privacyNote: "v8.0 | Chỉ lưu trong trình duyệt này. Không tải dữ liệu lên nhà phát triển.",
...
Object.assign(UI_TEXT.ru, {
    ...
    supportDeveloper: "Поддержать разработчика", privacyNote: "v8.0 | Хранится только в этом браузере. Данные не отправляются разработчику.",
...
Object.assign(UI_TEXT.ar, {
    ...
    supportDeveloper: "دعم المطور", privacyNote: "v8.0 | يتم الحفظ في هذا المتصفح فقط. لا يتم رفع أي بيانات إلى المطور.",
...
Object.assign(UI_TEXT.hi, {
    ...
    supportDeveloper: "डेवलपर का समर्थन करें", privacyNote: "v8.0 | केवल इसी ब्राउज़र में संग्रहीत। डेवलपर को कोई डेटा अपलोड नहीं होता।",
