# AI Title Translator - AI 이중 언어 YouTube 제목
...
V8부터 이 확장 프로그램은 중국어 번역 전용이 아닙니다. 일반적인 YouTube 제목 언어를 자동으로 처리하고 영어, 일본어, 한국어, 태국어, 스페인어, 프랑스어, 독일어, 포르투갈어, 인도네시아어, 베트남어 및 중국어 변형으로 번역할 수 있습니다.
