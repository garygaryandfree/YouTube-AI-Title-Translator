...
AI Title Translator là tiện ích Chrome dịch tiêu đề video YouTube bằng AI. Tiêu đề đã dịch hiển thị ở vị trí tiêu đề, còn tiêu đề gốc vẫn nằm bên dưới để đối chiếu, đọc và học ngôn ngữ.

Từ v8.0.1, tiện ích không còn chỉ là công cụ dịch sang tiếng Trung. Nó tự động xử lý các ngôn ngữ tiêu đề YouTube phổ biến và dịch sang tiếng Anh, Nhật, Hàn, Thái, Tây Ban Nha, Pháp, Đức, Bồ Đào Nha, Indonesia, Việt và các biến thể tiếng Trung.
