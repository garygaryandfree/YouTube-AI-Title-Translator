...
AI Title Translator إضافة Chrome تترجم عناوين YouTube بالذكاء الاصطناعي. يظهر العنوان المترجم في الأعلى ويبقى العنوان الأصلي تحته للمقارنة والتعلم.

منذ V8 يمكن الترجمة إلى الإنجليزية واليابانية والكورية والتايلاندية والإسبانية والفرنسية والألمانية والبرتغالية والإندونيسية والفيتنامية والصينية.

## الميزات الرئيسية

| تعرف متعدد اللغات | يعالج تلقائيا العناوين بلغات متعددة مدعومة |
|---|---|
| ترجمة سياقية بالذكاء الاصطناعي | يفهم الأسلوب والاختصارات والسياق المحلي |
| الترجمة + الأصل | الترجمة في الأعلى والأصل في الأسفل |
...
`Interface language` تغير لغة صفحة الإعدادات فقط. `Translate titles into` chooses the target language for YouTube titles. Turn on `Translation`, choose an AI provider and model, paste your API Key, save, then refresh YouTube.
...
ثبّت من Chrome Web Store أو نزّل أحدث `YouTube_AI_Title_Translator_v8.0.zip` من GitHub Releases ثم حمّله في `chrome://extensions/` مع Developer Mode.
