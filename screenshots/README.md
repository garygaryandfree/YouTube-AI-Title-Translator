...
- `v8.0.1/config-ui.png`：v8.0.1 多语言配置界面
- `v8.0.1/en-to-ja.png`、`v8.0.1/en-to-ko.png`、`v8.0.1/en-to-th.png`、`v8.0.1/en-to-es.png`：英文标题翻译到其他语言的 README 演示图
- `v8.0.1/zh-to-en.png`、`v8.0.1/zh-to-fr.png`、`v8.0.1/zh-to-de.png`、`v8.0.1/zh-to-pt.png`、`v8.0.1/zh-to-id.png`、`v8.0.1/zh-to-vi.png`：中文标题翻译到其他语言的 README 演示图
...
README 当前引用的是 `v8.0.1/` 下的配置界面和多语言翻译效果图。
